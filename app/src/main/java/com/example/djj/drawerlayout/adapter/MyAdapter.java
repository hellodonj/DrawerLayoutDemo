package com.example.djj.drawerlayout.adapter;
...
import com.example.djj.drawerlayout.MyAsyncTask;
import com.example.djj.drawerlayout.R;
import com.example.djj.drawerlayout.activity.MainActivity;
...
public class MyAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        convertView.setTag(R.id.progress_list, position);//此处将位置信息作为标识传递
